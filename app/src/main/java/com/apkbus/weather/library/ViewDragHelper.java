...
/**
 * 这是抄来的自定义辅助类，我也不知道里面究竟写了什么
 * 它提供了许多有用的操作和状态
 * 允许用户在父ViewGroup中拖动视图并重新定位
 */
...
public class ViewDragHelper {
     ...
     */
    static final int EDGE_ALL = EDGE_LEFT | EDGE_TOP | EDGE_RIGHT | EDGE_BOTTOM;
     ...
     */
    static final int DIRECTION_VERTICAL = 1 << 1;

    /**
     * Indicates that a check should occur along all axes
     */
    static final int DIRECTION_ALL = DIRECTION_HORIZONTAL | DIRECTION_VERTICAL;

    static final int EDGE_SIZE = 20; // dp
     ...
     * callback's
     * {@link com.apkbus.weather.library.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.apkbus.weather.library.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.apkbus.weather.library.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
     ...
     * {@link com.apkbus.weather.library.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
